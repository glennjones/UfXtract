...
[TestFixture]
public class test_value_dt_test_YYYY_MM_DD__12am_12pm
{
...
string url = "http://microformats.org/wiki/value-dt-test-YYYY-MM-DD--12am-12pm#uf";
...
string resultDateTime = new Rfc3389DateTime("2009-06-26T00").ToString();
...
string testDateTime = new Rfc3389DateTime(test).ToString();
string resultDateTime = new Rfc3389DateTime("2009-06-26T12").ToString();
Assert.That(testDateTime, Is.EqualTo(resultDateTime), "With the value class pattern the results should contain a time" );
}
