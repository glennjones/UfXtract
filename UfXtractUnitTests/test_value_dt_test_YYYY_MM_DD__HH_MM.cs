...
[TestFixture]
public class test_value_dt_test_YYYY_MM_DD__HH_MM
{
...
string url = "http://microformats.org/wiki/value-dt-test-YYYY-MM-DD--HH-MM#uf";
...
string resultDateTime = new Rfc3389DateTime("2009-06-26T19:00").ToString();
...
string testDateTime = new Rfc3389DateTime(test).ToString();
string resultDateTime = new Rfc3389DateTime("2009-06-26T22:00").ToString();
Assert.That(testDateTime, Is.EqualTo(resultDateTime), "With the value class pattern the results should contain a time" );
}
